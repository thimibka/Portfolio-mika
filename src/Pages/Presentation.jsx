...
export default function Home() {
  return (
    <>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <p>
              ...
              avec d&apos;autres passionnés pour créer des solutions robustes et
              durable.
              <br />
              Merci de prendre le temps de me connaître un peu mieux. J&apos;ai
              hâte de faire partie d&apos;une communauté dynamique et de relever
              de nouveaux défis.
            </p>
          </Card.Text>
        </Card.Body>
      ...
      <br />
      LINKEDIN :{" "}
      <a href="https://www.linkedin.com/in/gervais-mickael-thimibka">ici</a>
      <br />
